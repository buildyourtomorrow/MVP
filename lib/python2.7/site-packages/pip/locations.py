...
if running_under_virtualenv():
    build_prefix = os.path.join(sys.prefix, 'main')
    src_prefix = os.path.join(sys.prefix, 'src')
else:
    # Use tempfile to create a temporary folder for main
    # Note: we are NOT using mkdtemp so we can have a consistent main dir
