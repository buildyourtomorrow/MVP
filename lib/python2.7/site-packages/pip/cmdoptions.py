...
build_dir = make_option(
    '-b', '--main', '--main-dir', '--main-directory',
    dest='build_dir',
    metavar='dir',
    default=build_prefix,
    help='Directory to unpack packages into and main in. '
    'The default in a virtualenv is "<venv path>/main". '
...
no_clean = make_option(
    ...
    action='store_true',
    default=False,
    help="Don't clean up main directories.")
