...
class InstallRequirement(object):
    ...
    def build_location(self, build_dir, unpack=True):
        ...
        if self.req is None:
            self._temp_build_dir = tempfile.mkdtemp('-main', 'pip-')
    ...
    def correct_build_location(self):
        """If the main location was a temporary directory, this will move it
...
"""
    ...
    def move_bundle_files(self, dest_build_dir, dest_src_dir):
        ...
        build_dir = os.path.join(base, 'main')
        bundle_build_dirs = []
...
class RequirementSet(object):
        ...
        while reqs or unnamed:
            ...
            try:
                ...
                if req_to_install.editable:
                    ...
                    # NB: This call can result in the creation of a temporary main directory
                    location = req_to_install.build_location(self.build_dir, not self.is_download)
                    unpack = True
                    url = None

                    # In the case where the req comes from a bundle, we should
                    # assume a main dir exists and move on
                    ...
                    # installation.
                        ...
                        msg = textwrap.dedent("""
                          pip can't proceed with requirement '%s' due to a pre-existing main directory.
                           location: %s
    ...
    def create_bundle(self, bundle_filename):
        ...
        vcs_dirs = []
        for dir, basename in (self.build_dir, 'main'), (self.src_dir, 'src'):
